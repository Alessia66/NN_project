...
plt.savefig(f"result/{dataset_name}_{loss_name}_TotalConfusionMatrix.png", bbox_inches='tight')
#plt.show()

plt.figure(figsize=(15,10))
plot_confusion_matrix(cm, list(Labels_list), normalize=True)
plt.savefig(f"result/{dataset_name}_{loss_name}_TotalConfusionMatrixNormalized.png", bbox_inches='tight')
#plt.show()
